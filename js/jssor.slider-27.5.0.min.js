...
$(document).ready(function(){
  $(".junin").click(function(){
    $(".zonajunin").css("display", "block");
    $(".junin").css("background", "red");
  });
});
 $(document).ready(function(){
  $(".estudio").click(function(){
    $(".zona2").css("display", "block");
  ...
  $(document).ready(function(){
  $(".biosub").click(function(){
  	$(".zona3").css("display", "block");
